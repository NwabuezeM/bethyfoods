...
function HeroSection() {
    return (
        <div className="hero min-h-[80vh] lg:min-h-screen md:min-h-[90vh] flex justify-center text-white">
            ...
            <h1 className="animateTopIn z-40 mt-36 lg:mt-0 md:mt-0 text-[#d89423]">Best Food Delivery Service In Nigeria</h1>
            ...
            <div className="links flex flex-col md:flex-row lg:flex-row items-center gap-12 z-40">
                ...
                <Link to={'/reservation'} className="text-white py-4 px-6 rounded-full border-2 border-white uppercase hover:text-white hover:bg-[#ff6347] hover:border-none">Request a Special Order</Link>
            </div>
            </div>
        </div>
    )
