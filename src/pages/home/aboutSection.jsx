  ...
  return (
    <div className="pb-12">
      <div className="flex justify-center">
        <img src="https://ofefoods.com/storage/2021/07/afang-soup.jpeg" alt="img" className="w-[150px] h-[150px] rounded-full translate-y-[-50%] z-[99] lg:w-[400px] lg:h-[400px]" />
      </div>
      <div className="our-story grid lg:grid-cols-2 px-5 lg:px-12 lg:mx-24 gap-8 lg:gap-20 md:gap-16 mt-[-50px] lg:mt-[-50px]">
        <div className="story flex flex-col mx-auto lg:mx-0 gap-12">
          <h2 className="rotateAnimation text-center md:text-left lg:text-left">BethyFoods Delicacy</h2>
        ...
        <div className="images flex gap-8 w-[90%]">
